...
class VPC:
    ...
    def spin_l2_bridges(self,no_vms,each):
        ...
        if int(no_vms) > 1:
            ...
            print("cd /home/ece792/vpc/ && sudo python3 ./hyp2_br.py " + str(tenant_check) + " " + str(each))
            ...
            print("cd /home/ece792/vpc/ && sudo python3 ./hyp2_veth.py " + str(tenant_check) + " " + str(each))
...
#            Throw the VM on Hypersor #2 if this condition suceeds
            ...
            for each_subnet in sub_list:
                ...
                --mac 52:54:00:4b:73:5f --config --live
                '''
                print("python3 /home/ece792/vpc/final_vm_attach.py " + str(tenant_check) + " " + str(domain_name) + " " + str(each) + " " + str(each_subnet))
