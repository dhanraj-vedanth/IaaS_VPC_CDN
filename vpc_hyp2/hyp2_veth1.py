...
#   print(os.system("sudo ovs-vsctl add-port tenant" + str(tenant_check) + "br_" + str(each) + " t" + str(tenant_check) + "_" + str(each)))
    ...
    pid=os.popen('docker inspect -f \'{{.State.Pid}}\' ' +"NS_tenant" + str(tenant_check) + "_" + str(each)).read()
    print(pid)
    pid = pid.split('\n')[0]
    ...
    print(os.system("sudo docker exec -it" + str(tenant_check) + "_" + str(each) + " ip link set t" + str(tenant_check) + "r up"))
    ...
    print(os.system("ip link set netns "+pid+" dev t"+str(tenant_check) + "r" ))

    '''

    print(os.system("sudo docker exec -it NS_tenant" + str(tenant_check) + "_" + str(each) + " ip link set t" + str(tenant_check) + "vxr up"))
    print(os.system("sudo docker exec -it NS_tenant" + str(tenant_check) + "_" + str(each) + " brctl addif BR_NS t" + str(tenant_check) + "vxr"))
